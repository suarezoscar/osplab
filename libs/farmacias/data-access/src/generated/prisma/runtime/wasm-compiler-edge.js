...
function Mt(e, t) {
  ...
  if (
    ((f += v), (R.precision = f), (r = xe(N)), (n = r.charAt(0)), (o = G(A)), Math.abs(o) < 15e14)
  ) {
  ...
  uo = be(() => {
    ...
    ke = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (
          m = n.e - i.e, ge = J.length, Qe = we.length, A = new yr($l), N = A.d = [], f = 0;
          J[f] == (we[f] || 0);
  ...
  async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
    ...
    if (Ku(t)) s = Zu(t);
      ...
      v
        ...
        : (Me('query plan cache miss'), (s = this.#f(m, T, o)), S && this.#i.setSingle(T, s));
    }
    try {
